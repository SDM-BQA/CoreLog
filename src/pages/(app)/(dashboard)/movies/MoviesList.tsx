...
const MoviesList = () => {
  ...
  return (
    <div className="bg-bg flex-1 overflow-y-auto custom-scrollbar">
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-8 py-2.5 sm:py-5 flex flex-col">
        ...
        {/* View Toggle */}
        <div className="flex items-center justify-between border-b border-border/50 pb-1.5 sm:pb-2 mb-2.5 sm:mb-3 shrink-0">
