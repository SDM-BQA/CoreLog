  ...
  const { values, errors, handleChange, setFieldValue, handleSubmit } =
    useForm<AddSeriesForm>({
      ...
      validationSchema: {
        ...
        seasons: (val) => (val ? null : "Number of seasons is required"),
      },
      onSubmit: (formValues) => {
        if (formValues.status === "Watched" && !formValues.review) {
          alert("Please add a review for watched series.");
          return;
        }
        console.log("Submitting web series:", formValues);
        alert(`Web Series "${formValues.title}" added successfully!`);
      },
    });
      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-text-secondary text-sm mt-2">
            Enter the details to update your personal web series collection.
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-8">
            ...
            <div className="flex flex-col gap-6 flex-1 min-w-0">
              ...
              <div>
                ...
                <textarea
                  placeholder="A brief summary of the series plot..."
