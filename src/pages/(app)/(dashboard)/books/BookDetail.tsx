      ...
      <div className="max-w-[920px] mx-auto px-6 py-10 flex flex-col gap-8">
        ...
        {(currentStatus === "reading" || currentStatus === "read" || currentStatus === "not_finished") && (
          <MediaLog
            ...
            activeStatuses={["reading"]}
            unitLabel="page"
            unitIcon={<BookOpen size={14} />}
            completedLabel="You've finished the book!"
            total={book.page_count ?? 0}
            logs={logs.map(l => ({ _id: l._id, date: l.date, position: l.current_page, note: l.note }))}
            onAdd={handleAddLog}
